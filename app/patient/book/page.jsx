...
import { CalendarIcon, FileAudio, Loader2, Sparkles } from "lucide-react"
              ...
              <CardContent className="space-y-6">
                ...
                <div className="rounded-2xl border border-teal-100 bg-gradient-to-br from-teal-50 via-white to-amber-50 p-5">
                  <div>
                    ...
                    <h3 className="mt-2 text-lg font-semibold text-gray-900">Upload a voice sample</h3>
                    <p className="mt-1 max-w-2xl text-sm text-gray-600">
                      Upload a short speech sample. We analyze it with the trained Torgo model before matching you to a therapist.
                    </p>
                  </div>
